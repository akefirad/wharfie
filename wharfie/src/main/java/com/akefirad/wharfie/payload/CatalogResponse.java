...
public class CatalogResponse extends EntityResponse {
    public static final CatalogResponse NO_REPOSITRY =
            new CatalogResponse(emptyMap(), emptyList());

    private int number;
    private String last;
    private List<String> repositories;

    public CatalogResponse (Map<String, List<String>> headers,
    ...
    public CatalogResponse (Map<String, List<String>> headers,
                            List<String> repositories, int number) {
        super(headers);
        init(number, null, repositories);
    }

    public CatalogResponse (Map<String, List<String>> headers,
                            List<String> repositories, int number, String last) {
        super(headers);
    ...
    private void init (int number, String last, List<String> list) {
        this.number = number;
        this.last = last;
        this.repositories = new ArrayList<>(ofNullable(list).orElse(emptyList()));
    }
}
